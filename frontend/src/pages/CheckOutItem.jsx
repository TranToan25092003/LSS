...
const CheckoutItemPage = () => {
    ...
    const [borrowDuration, setBorrowDuration] = useState(data?.borrowDuration || 1); // Thời gian mượn mặc định
    ...
    const handleConfirm = async () => {
        try {
            ...
            const borrowInfo = {
                borrowerClerkId: data.borrowerClerkId, // ID người mượn
            ...
            if (values.paymentMethod === "vnpay") {
                ...
                const vnpayResponse = await axios.post("http://localhost:3000/vnpay/create-payment", {
                    amount: totalPrice,
                    orderId: orderId,
                ...
                const response = await axios.post("http://localhost:3000/borrow", borrowInfo);
            ...
            if (error.response) {
                ...
                message.error(error.response.data.message || "Đã xảy ra lỗi khi lưu dữ liệu mượn.");
            } else {
            ...
            <Card title="Borrow Confirmation" style={styles.card}>
                ...
                <Form form={form} layout="vertical" style={styles.form}>
                    ...
                    <div style={styles.totalPrice}>
                        ...
                        <span>{data.isFree ? "FREE" : `${totalPrice.toLocaleString()} đ`}</span>
                    </div>
                    ...
                    <Button type="primary" onClick={handleConfirm} block style={styles.button}>
                        Xác nhận mượn
                    </Button>
                </Form>
            </Card>
