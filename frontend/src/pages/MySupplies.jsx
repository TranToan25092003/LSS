...
import { Search, Plus, Filter, RefreshCw, Edit, Trash2, Check, X } from "lucide-react"
...
const changeLendStatus = async (itemId, currentStatus, navigate) => {
  ...
  if (result.isConfirmed) {
    try {
      ...
      toast("Success", { description: `Item has been ${actionText.toLowerCase()}ed` })
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">Manage your items available for lending</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
            ...
            <Button
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600"
              onClick={() =>
                toast("Feature coming soon", { description: "Add item functionality will be available soon" })
              }
            >
          ...
          <Tabs defaultValue="all" value={activeTab} onValueChange={setActiveTab}>
            <div className="flex justify-between items-center mb-4">
              <TabsList className="bg-gray-100 dark:bg-gray-800">
                ...
                <TabsTrigger value="free" className="data-[state=active]:bg-white dark:data-[state=active]:bg-gray-700">
                  Free Items
                </TabsTrigger>
              </TabsList>
                  ...
                  {filteredData.map(({ item }) => (
                    ...
                    >
                      ...
                      <CardContent className="flex-1 pt-6">
                        ...
                        {!item.isFree && (
                          <p className="font-medium text-lg text-purple-600 dark:text-purple-400">
                            ...
                            <span className="text-sm text-gray-500 dark:text-gray-400"> / {item.rate}</span>
                          </p>
                        )}
                      </CardContent>
                      <CardFooter className="flex gap-2 pt-2 pb-4">
                        ...
                        <Button className="flex-1 bg-blue-500 hover:bg-blue-600" onClick={() => handleEdit(item._id)}>
